...
public class Setautorestart extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public Setautorestart() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.setContentType("text/html");
		PrintWriter out = response.getWriter();
		System.out.println(request.getParameter("ports"));
		...
		for (String port : request.getParameter("ports").split(":")) {
			Serverlist.serverlist.setautorestart(port, hour, min);
		}
		response.sendRedirect("/L4d2_Server_Protector/serverstatus.jsp");
	}
